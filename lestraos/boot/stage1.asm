...
pm32:
    ...
    ; ELF says _start is at VMA 0x11000, but stage1 loads kernel from file
    ; offset 0x200 (=LBA 1) into memory 0x10000. The .text segment is at file
    ; offset 0x2000 (multiboot2 header takes 4KB), so _start lands at
    ; physical address 0x10000 + (0x2000 - 0x200) = 0x11E00.
    mov eax, 0x11E00
    jmp eax
