...
/* In-kernel snprintf - writes at most size-1 chars + NUL to buf.
 * Supports %s, %d, %u, %x, %c, %%, ignores width/precision/length mods.
 * Returns the number of chars that WOULD have been written (excluding
 * NUL), like standard snprintf. */
