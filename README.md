...
|---|---|
| [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) | Kernel architecture, memory layout, boot process |
| [`docs/BUILD.md`](docs/BUILD.md) | Build instructions, cross-compiler, troubleshooting |
| [`docs/NETWORKING.md`](docs/NETWORKING.md) | TCP/IP stack, TLS, AI client, package downloads |
| [`docs/AI.md`](docs/AI.md) | AI subsystem, providers, tools, request formats |
| [`docs/LESTRAMANIKA.md`](docs/LESTRAMANIKA.md) | GGUF engine integration guide |
| [`docs/USERSSPACE.md`](docs/USERSSPACE.md) | Syscall ABI, user ABI, adding binaries |
| [`docs/BOOT.md`](docs/BOOT.md) | 20 bugs found & fixed during development |
| [`docs/CHANGES.md`](docs/CHANGES.md) | Complete diff summary of modified/new/removed files |
